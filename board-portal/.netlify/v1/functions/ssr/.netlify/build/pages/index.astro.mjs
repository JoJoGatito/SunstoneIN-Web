...
const astroLogo = new Proxy({"src":"/_astro/astro.Dm8K3lV8.svg","width":115,"height":48,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/yordan/Projects/SunstoneIN-Web/board-portal/src/assets/astro.svg";
							}
...
const background = new Proxy({"src":"/_astro/background.BPKAcmfN.svg","width":1440,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/yordan/Projects/SunstoneIN-Web/board-portal/src/assets/background.svg";
							}
...
}, "/Users/yordan/Projects/SunstoneIN-Web/board-portal/src/pages/index.astro", void 0);

const $$file = "/Users/yordan/Projects/SunstoneIN-Web/board-portal/src/pages/index.astro";
const $$url = "";
